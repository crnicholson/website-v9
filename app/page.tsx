    ...
    return (
      ...
      >
        ...
        <div className="z-10">
          ...
          <p className="mb-4">I've worn many hats over the years, but currently I'm GitHub's youngest intern and a software engineer at a NYC-based stealth startup. In the background, I'm working on my own startup focusing on robotics and AI. Previously, I've also organized international hackathons in near space and helped teens learn how to code. If you want to learn more about my past experiences, navigate to <Link className="underline" href="/cv">this</Link> page.</p>
